...
<?php echo form_open($this->uri->uri_string(), "class='navbar-form' id='login-form' name='login-form'"); ?>
<div class="control-view"><strong>ID Pengguna</strong></div>
<input type="text" id="login" name="login" class="" placeholder="ID Pengguna" autocomplete="off" value="<?php echo ($this->input->post('login') != '') ? $this->input->post('login') : ''; ?>">
