...
<fieldset>
    ...
    <input type="hidden" id="user_level" name="user_level" value="<?php echo set_value('user_level', $user_profile->user_level); ?>">
    <input type="hidden" id="activated" name="activated" value="<?php echo set_value('activated', $user_profile->activated); ?>">
    ...
    <div class="tab-content">
        <div class="tab-pane fade active in" id="userprofile">
            ...
            <div class="control-group">
                ...
                <?php if ($this->tank_auth->is_admin() && ($user_profile->id != $this->tank_auth->get_user_id())): ?>
                    <div class="controls">
                      <select name="user_level" class="span2">
                            <option value="1" <?php echo ($user_profile->user_level == 1) ? "selected" : ""; ?>>Pentadbir Utama</option>
                            <option value="0" <?php echo ($user_profile->user_level == 0) ? "selected" : ""; ?>>Pengguna</option>
                            <option value="2" <?php echo ($user_profile->user_level == 2) ? "selected" : ""; ?>>Pentadbir Bahagian</option>
                            <option value="3" <?php echo ($user_profile->user_level == 3) ? "selected" : ""; ?>>Ketua Pemandu</option>
                            <option value="4" <?php echo ($user_profile->user_level == 4) ? "selected" : ""; ?>>Pentadbir Peralatan</option>
                        </select>
                    </div>
                <?php else: ?>
                    <div class="control-label">
            ...
            <div class="control-group">
                ...
                <div class="control-label">
                    <label class="align-left span4" for="full_name"><strong><?php echo $user_profile->full_name; ?></strong></label>
                    <input type="hidden" class="span4" id="full_name" name="full_name" value="<?php echo $user_profile->full_name; ?>"> 
            ...
            <div class="control-group">
                ...
                <div class="control-label">
                    <label class="align-left span4" for="department_name"><strong><?php echo $user_profile->kodwaran; ?> - <?php echo $user_profile->department_name; ?></strong></label>
                    <input type="hidden" class="span4" id="department_name" name="department_name" value="<?php echo $user_profile->department_name; ?>">
                     <!--<span class="label label-important validate-required">Wajib</span>
            ...
            <div class="control-group">
                ...
                <div class="control-label">
                    <label class="align-left span4" for="position_id"><strong><?php echo $user_profile->position_name; ?></strong></label>
                    <input type="hidden" class="span4" id="position_name" name="position_name" value="<?php echo $user_profile->position_name; ?>">
                     <!--<span class="label label-important validate-required">Wajib</span>
            ...
            <div class="control-group">
                ...
                <div class="control-label">
                    <label class="align-left span4" for="position_level"><strong><?php echo $user_profile->position_level; ?></strong></label>
                    <input type="hidden" class="span1" id="position_level" name="position_level" value="<?php echo $user_profile->position_level; ?>">
                     <!--<span class="label label-important validate-required">Wajib</span>
            ...
            <div class="control-group">
                ...
                <div class="control-label">
                    <label class="align-left span4" for="contact_office"><strong><?php echo $user_profile->contact_office; ?></strong></label>
                    <input type="hidden" class="span2" id="contact_office" name="contact_office" value="<?php echo $user_profile->contact_office; ?>">
                   <!--Sambungan
            ...
            <div class="control-group">
                ...
                <div class="control-label">
                    <label class="align-left span4" for="contact_mobile"><strong><?php echo $user_profile->contact_mobile; ?></strong></label>
                    <input autocomplete="off" type="hidden" class="span2" id="contact_mobile" name="contact_mobile" maxlength="20" value="<?php echo $user_profile->contact_mobile; ?>">
                </div>
            </div>
        </div>
