...
<!--                        <td class="nolink"><input type="checkbox" name="delete[<?php echo $booking->booking_id; ?>]" value="<?php echo $booking->booking_id; ?>"></td>-->
                    ...
                    <td>
                        <strong>
<?php echo "Nama Bilik : {$booking->name}<br/> Tingkat : {$booking->floor}<br/> Blok : {$booking->building}<br/>Lokasi : {$booking->location}"; ?></strong></td>
                    <td>
                        <strong>Tujuan:
                        <?php echo $booking->room_purpose; ?>
                        <br/>Urusetia: <?php echo  ucwords(strtolower($booking->secretariat)); ?>
                        <?php
