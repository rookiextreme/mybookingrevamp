...
<fieldset>
    ...
    <input type="hidden" id="quantity" name="quantity" value="<?php echo set_value('name', !empty($equipment) ? $equipment->quantity : 0); ?>">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" class="span4" id="model" name="model" value="<?php echo set_value('model', !empty($equipment) ? $equipment->model : ''); ?>">
            <span class="label label-important validate-required">Wajib</span>
            <p class="help-block"><i>"Dell Latitude E6330"</i></p>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="no_siri">No.Siri</label>
        <div class="controls">
            <input type="text" class="span4" id="no_siri" name="no_siri" value="<?php echo set_value('no_siri', !empty($equipment) ? $equipment->no_siri : ''); ?>">
            <span class="label label-important validate-required">Wajib</span>
            <p class="help-block"><i>"SGH425421"</i></p>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="no_ruj">Label</label>
        <div class="controls">
            <input type="text" class="span4" id="no_ruj" name="no_ruj" value="<?php echo set_value('no_ruj', !empty($equipment) ? $equipment->no_ruj : ''); ?>">
            <span class="label label-important validate-required">Wajib</span>
            <p class="help-block"><i>"H-01"</i></p>
        </div>
    </div>
    <div class="control-group">
