            ...
            <table width="80%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="left" width="95%" style="font: 13px/18px Arial, Helvetica, sans-serif;">
                        ...
                        <p><strong><span style='text-decoration: underline;'>PEMBERITAHUAN TEMPAHAN DIBATALKAN</span></strong></p>

                        <p>Tempahan anda yang bernombor <?php echo $booking_ref_no ?> di dalam <?php echo $site_name; ?> <strong>DIBATALKAN</strong> oleh Sistem <?php echo $site_name; ?> JKR.</p>
