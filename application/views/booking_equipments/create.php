...
<fieldset>
    ...
    <div class="well well-form">
        ...
        <div class="control-group">
            <label class="control-label" for="start_date">Masa Pengambilan Barang</label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label" for="end_date">Masa Pemulangan Barang</label>
            <div class="controls">
        ...
        <div class="control-group">
            <div class="controls">
                <button id="check_availability" class="btn btn-small btn-primary" type="button"><i class="icon-refresh"></i> Semak Status Peralatan</button>
            </div>
        </div>
                    ...
                    <?php foreach ($equipments as $equipment): ?>
                        <?php if (!$equipment->deleted && ($equipment->status)): ?>
                            <div class="input-prepend input-append">
                                <span class="add-on width1-add-on"><?php echo $equipment->name.' - '.$equipment->model?></span>
    ...
    <div class="form-actions padding-left0">
        <div class="control-group simpan">
            <div class="controls">
