...
<fieldset>
    ...
    <div class="tab-content">
        ...
        <div class="controls">
		<label class="radio">
                <input type="radio" name="outstation" id="tidak" value="0"  <?php echo ((!empty($transport) && $transport->status == 1) || empty($transport)) ? 'checked' : ''; ?>> Tidak Outstation Dan Bermalam
            </label>
            <label class="radio">
                <input type="radio" name="outstation" id="outstation" value="1" <?php echo (!empty($transport) && empty($transport->status) ? 'checked' : ''); ?>> Outstation Dan Bermalam
            </label>
