<!DOCTYPE html>
<?php
$protocol = (isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
echo $protocol.'...'; 
?>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>MyBooking - Sistem Tempahan Bilik Mesyuarat dan Sumber</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="">
        <meta name="author" content="">

        <link href="https://mybooking.jkr.gov.my/assets/css/normalize.css" rel="stylesheet"/>

        <link href="https://mybooking.jkr.gov.my/assets/css/event-calendar/eventCalendar.css" rel="stylesheet">
        <link href="https://mybooking.jkr.gov.my/assets/css/event-calendar/eventCalendar_theme_responsive.css" rel="stylesheet">

        <link href="https://mybooking.jkr.gov.my/assets/css/bootstrap.css" rel="stylesheet">
        <link href="https://mybooking.jkr.gov.my/assets/css/bootstrap-responsive.min.css" rel="stylesheet">
        <link href="https://mybooking.jkr.gov.my/assets/css/font-awesome.css" rel="stylesheet">
        <link href="https://mybooking.jkr.gov.my/assets/css/style.css" rel="stylesheet">



        <link href="https://mybooking.jkr.gov.my/assets/css/custom.css" rel="stylesheet">

        <script src="https://mybooking.jkr.gov.my/assets/js/jquery.js"></script>
        <script src="https://mybooking.jkr.gov.my/assets/js/event-calendar/jquery.eventCalendar.js" type="text/javascript"></script>
    </head>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <div class="navbar-logo pull-left">
                        <img src="<?php echo base_url('assets/img/Logo-Jab-Kerja-Raya.png') ?>" style="width: 55px;"/>
...
<!--                    <h4><i class="icon-calendar"></i> Kalendar Tempahan</h4>
        ...
        <div class="container">
            <div class="nav footer">
                <hr/><p>Hak Cipta © 2014. Jabatan Kerja Raya.<br/><img src="<?php echo base_url('assets/img/mybooking-logo.png') ?>" style="width: 100px;"/></p>
            </div>
        </div>
        ...
        <script src="https://mybooking.jkr.gov.my/assets/js/bootstrap.js"></script>
    </body>
</html>
