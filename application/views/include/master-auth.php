                    ...
                    <div class="row">
                        ...
                        <div class="span6">
                            ...
                            <div class="nav-collapse collapse">
                                ...
                                $display_name = (!empty($username)) ? $username : $fullname;
                                ?>

                                <ul class="nav pull-right">
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $display_name; ?> <i>(<?php echo $fullname; ?><?php $this->load->model('user_model') ?>)</i><b class="caret"></b></a>
                ...
                <div class="span3">
                    <div class="well box-shadow" style="max-width: 340px; padding: 8px 0;">
                        <ul class="nav nav-list">
                            ...
                            <?php if ($this->tank_auth->is_adminperalatan()): ?>
                                <li class="nav-header">Pengurusan Rekod</li>
                                <li class="<?php echo ($current_page == 'equipments') ? 'active' : ''; ?>"><?php echo anchor('equipments', '<i class="icon-list-alt"></i> Peralatan'); ?></li>
                                <li class="divider"></li>
                            <?php endif; ?>
...
<!--                            <li><a href="#"><i class="icon-info-sign"></i> Bantuan</a></li>-->
        ...
        <div class="container footer">
            <hr/>
            <p>Hak Cipta © 2014. Jabatan Kerja Raya.<br/><img src="<?php echo base_url('assets/img/mybooking-logo.png') ?>" style="width: 100px;"/></p>
        </div>

        <script src="<?php echo base_url('assets/js/event-calendar/jquery.eventCalendar.js') ?>" type="text/javascript"></script>
        <script src="<?php echo base_url('assets/js/latestJSUI/jquery-ui.js') ?>"></script>
        <script src="<?php echo base_url('assets/js/timepicker/jquery-ui-timepicker-addon.js') ?>"></script>
        <?php
            $url = $_SERVER['REQUEST_URI'];
            if($url != '/mybooking/booking_rooms/create'){
        ?>
