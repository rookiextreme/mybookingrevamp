...
<fieldset>
    <input type="hidden" id="id" name="id" value="<?php echo set_value('room_id', !empty($room) ? $room->room_id : 0); ?>">
    ...
    <div class="control-group">
        ...
        <?php endif; ?>
    <!--tukar if lame . if lame slh . ake 4.10.14 -->
    <?php if ($this->tank_auth->is_subadmin()): ?>
    
    <div class="control-group">
            <div class="controls">
                <input type="hidden" class="span4" id="fk_user_id" name="fk_user_id" value="<?php echo set_value('fk_user_id', !empty($room) ? $room->fk_user_id : ''); ?>">
            </div>
        </div>
        <?php endif; ?>
