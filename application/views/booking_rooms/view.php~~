...
<fieldset id='booking-details'>
        ...
        <div class="control-group">
            ...
            <div class="control-label">
                <label class="align-left span7">
                    ...
                    <!-- -Hide kan status tempahan mknn dan peralatan- <?php if ($status_food_label): ?>
            ...
            <div class="control-label">
                <?php if ($owner): ?>
                    <label class="align-left span3"><strong><?php echo $owner->full_name; ?> 
                            <br/><a href="<?php echo "mailto:{$owner->email}"; ?>"><?php echo "{$owner->email}"; ?></a><br/> <?php echo "{$owner->contact_office}" ?></strong></label>
                <?php else: ?>
    ...
    <div class="tab-content">
        <div class="tab-pane fade active in" id="mesyuarat">
            ...
            <div class="control-group">
                ...
                <div class="control-label">
                    <label class="align-left span4" for="secretariat">
                        <strong><?php echo $booking->secretariat; ?></strong><br>
                        <?php if ($getname):?>
                        <strong>Nombor telefon bimbit: <?php echo $booking->secretariat_phone_no; ?></strong><br>
                        <strong><a href="<?php echo "mailto:{$getname->email}"; ?>"><?php echo "{$getname->email}"; ?></a></strong><br>
                        <strong><?php echo "{$getname->department_name} ({$getname->cawangan_name}) - {$getname->kodwaran}" ; ?></strong><br>
                        <strong><?php echo $getname->contact_office; ?></strong>
                        
                        <?php else: ?>
                        <strong><?php echo $booking->secretariat_phone_no; ?></strong><br>
    ...
    <div class="form-actions">
        ...
        <?php if (!in_array($booking->booking_status, array(6, 8)) && (($this->tank_auth->is_admin() || $this->tank_auth->is_subadmin()) || ($booking->fk_user_id == $this->tank_auth->get_user_id()))): ?>
            <div class="control-group">
                <label class="control-label" for="name">Tindakan/Status <?php echo ($booking->booking_mode > 1) ? "Bilik" : ""; ?></label>
                <div class="controls margin-bottom10">
                    ...
                    if ($this->tank_auth->is_admin() && ($booking->room_owner != 0) && $this->tank_auth->is_normal_user()){
                    ...
                    <div class="controls">
                        ...
                        <select id="approve_food" name="approve_food" class="span2" <?php echo $food_approve_visibility; ?>>
                            <?php if ($booking->booking_closed <= 1): ?>
                                <option value="">-- Sila Pilih</option>
                            <?php endif; ?>
                            <?php if (in_array($booking->booking_status, array(1, 3, 7))): ?>
