...
<!--                        <td class="nolink"><input type="checkbox" name="delete[<?php echo $booking->booking_id; ?>]" value="<?php echo $booking->booking_id; ?>"></td>-->
                    ...
                    <td>
                        ...
                        ?>
			   <br/><strong>Waktu Tempahan:</strong> <?php echo $booking->created; ?>
                        <!-- Hide status mknn alatan untuk view list tempahan -<br/><strong>Tempahan Makanan: </strong><?php echo (!empty($booking->fk_booking_food_id)) ? (!empty($no_food) ? "Ditolak" : "Ada") : "Tiada"; ?>
...
<?php endif; ?>
    <input type="button" onclick="printDiv('printableArea')" value="Cetak Senarai Tempahan Bilik" />
