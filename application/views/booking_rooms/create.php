        ...
        <div class="tab-content">
            ...
            <!--                            <option <?php echo $set_selected_room; ?> value="<?php echo $room->room_id; ?>"><?php echo "{$room->building} {$room->floor} {$room->name}"; ?> (<?php echo $room->capacity; ?>)</option>-->
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="secretariat2" name="secretariat" class="span4 secretariat2" placeholder="Taip Nama Urusetia" style="margin: 0 auto;" data-provide="typeahead">
                        <span class="label label-important validate-required">Wajib</span>
                    </div>
                </div>
                <div class="control-group">
...
<script type='text/javascript' language='javascript'>
    $(document).ready(function() {
        ...
        $( ".secretariat2" ).autocomplete({
            source: "<?php echo site_url('booking_rooms/getalluser'); ?>",
            dataType: 'json',
            select:function(event,ui){
                $(".secretariat2").val(ui.item.label);
