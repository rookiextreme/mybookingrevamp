...
<fieldset>
    ...
    <div class="well well-form">
		...
		<table><tr><td></td><td><p style="color:red;padding-left:10px;font-weight:bolder;">Nota Penting/Peringatan : Makanan secara buffet/makan berat untuk makan tengah hari @ lunch tidak dibenarkan didalam semua bilik mesyuarat . Sila tempah Mezzanine kiri/kanan untuk makan tengah hari @ lunch.</td></tr></p></table></div>
        <div class="control-group">
    ...
    <div id="form-details">
        ...
        <div class="tab-content">
            ...
            <!--                            <option <?php echo $set_selected_room; ?> value="<?php echo $room->room_id; ?>"><?php echo "{$room->building} {$room->floor} {$room->name}"; ?> (<?php echo $room->capacity; ?>)</option>-->
                        ...
                        <span class="label label-important validate-required">Wajib</span>
                        <p class="help-block"><i>"Bangunan,Tingkat,Nama Bilik,Kapasiti Bilik"</i></p>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="room_purpose">Nama Mesyuarat</label>
                    <div class="controls">
                        <!--<input type="text" class="span4" id="capacity" name="capacity" maxlength="150" value="<?php echo set_value('capacity', !empty($room) ? $room->capacity : ''); ?>"> -->
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="secretariat" name="secretariat" class="span4" placeholder="Taip Nama Urusetia" style="margin: 0 auto;" data-provide="typeahead" data-items="8" data-source='[<?php echo $user_list; ?>]'>
    <!--                    <input type="text" class="span4" id="secretariat" name="secretariat" placeholder="Taip Nama Urusetia" data-source='[<?php echo $user_list; ?>]' value="<?php //echo set_value('secretariat', !empty($booking) ? $booking->secretariat : '');    ?>">-->
                        <span class="label label-important validate-required">Wajib</span>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="secretariat_new_phone_no">No. Telefon Urussetia</label>
                    <div class="controls">
                        <input type="text" id="secretariat_new_phone_no" name="secretariat_new_phone_no" class="span4 secretariat_new_phone_no" placeholder="Taip No. Telefon Urusetia" style="margin: 0 auto;" required>
                        <span class="label label-important validate-required">Wajib</span>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="chairman" name="chairman" class="span4" placeholder="Taip Nama Pengerusi" style="margin: 0 auto;" data-provide="typeahead" data-items="8">
...
<script type='text/javascript' language='javascript'>
    $(document).ready(function() {
        ...
        // $( ".secretariat_new_phone_no" ).autocomplete({
        //     lookup: availableTags,
        // });

        $( "#secretariat" ).autocomplete({
            source: window.location.origin + '/booking_rooms/getalluser',
            dataType: 'json',
            select:function(event,ui){
                $("#secretariat").val(ui.item.label);

                if(ui.item.value != ui.item.label){
                    $(".secretariat_new_phone_no").val(ui.item.value);
                }
                return false;
