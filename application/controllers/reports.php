...
class Reports extends CI_Controller {
    ...
    function index() {
        ...
        if ($this->input->post('report_type') == "room") {
            $this->generate_report_rooms();
            exit;
        }
    ...
    function generate_report_rooms() {
        $this->load->model('Booking_model');
        ...
        if ($this->input->post('start_date')):
            ...
            $bookings = $this->Booking_model->getRecordsForRoomsByDate($params, true);
            ...
            if (!empty($bookings)):
                ...
                foreach ($bookings as $booking):
                    $db_data[] = array(
                        ...
                        'urusetia' => "Urusetia: $booking->secretariat" . "\n" ."($booking->cawangan_name)",
                        'pengerusi' => "Pengerusi: $booking->chairman",
                        'Waktu' => "Mula: " . date('d/m/Y h:i A', strtotime($booking->start_date)) . " \nTamat: " . date('d/m/Y h:i A', strtotime($booking->end_date)),
                        'total_from_agensi' => "Pegawai Agensi : $booking->total_from_agensi \nPegawai Luar : $booking->total_from_nonagensi",
                        //'total_from_nonagensi' => $booking->total_from_nonagensi,
                        'booking_status_description' => $booking->room_purpose);
                endforeach;
                ...
                $col_names = array(
                    ...
                    'pengerusi' => 'Pengerusi',
                    'Waktu' => 'Waktu',
                    'total_from_agensi' => 'Jumlah Pegawai',
                    //'total_from_nonagensi' => 'Jumlah Pegawai Luar',
                    'booking_status_description' => 'Tujuan'
                );
                ...
                if ($date2):
                    $report_title = "Senarai Tempahan Bilik: $date1 - $date2";
                else:
                    $report_title = "Senarai Tempahan Bilik: $date1";
                endif;
            ...
            if (!empty($bookings)):
                ...
                foreach ($bookings as $booking):
                    $db_data[] = array(
                        ...
                        'booking_status_description' => $booking->driver);
                endforeach;
                ...
                $col_names = array(
                    ...
                    'booking_status_description' => 'Pemandu',
                    'detail' => 'Maklumat Tempahan'
                );
                ...
                $this->cezpdf->ezTable($db_data, $col_names, $report_title, array('width' => 570));
                $this->cezpdf->ezText("\n");
                //$this->cezpdf->ezTable($t_total, $t_total_name, 'Total Tempahan ', array('width' => 550));
